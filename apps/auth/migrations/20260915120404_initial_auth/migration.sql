...
ALTER TABLE "auth_oidc_approvals" ADD CONSTRAINT "auth_oidc_approvals_user_id_auth_users_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth_users"("id") ON DELETE CASCADE;--> statement-breakpoint
