    ...
    return (
        <Card className="space-y-4">
            <SectionHeader
                ...
                badge={
                    data && (
                        <Badge tone={data.control.paused ? "neutral" : availabilityTone}>
                ...
                <>
                        ...
                        {jobStates.map((state) => (
                            ...
                            >
                                ...
                                <dd className="mt-1 text-2xl font-semibold tabular-nums">
                                    {data.counts.find((count) => count.state === state)
                                        ?.count ?? 0}
                                </dd>
                            </div>
                        ))}
                    ...
                    {data.control.paused && (
                        <p className="rounded-lg border border-primary-700 bg-primary-900/40 p-3 text-sm text-primary-300">
                            Scheduled submissions and new job claims are paused. Manual
                            requests stay queued until you resume. Running jobs finish
                            normally.
                        </p>
                    )}
                    <DataTable
                        ...
                        columns={[
                            ...
                            },
                            {
                                ...
                                render: (worker) => {
                                    ...
                                    return (
                                        <Badge
                                            tone={worker.online ? "positive" : "neutral"}
                                        >
                                            {worker.draining ? "Stopped" : availability}
                                        </Badge>
                                    );
                                },
                            },
                            ...
                            },
                            {
                                ...
                                render: (worker) => formatDateTime(worker.heartbeatAt),
                            },
                        ]}
                    />
                </>
                ...
                <ConfirmDialog
                    ...
                    description={
                        confirmation.paused
                            ...
                            : "Stop accepting new work. Running jobs will finish; queued jobs will wait. An intentional pause is not an error."
                    }
