...
export function DataTableRow<T>({
    ...
    const hasInlineActions = columns.some((column) => column.mobile === "actions");
    return (
        <tr
            ref={measureElement}
            data-index={index}
            className={cn(
                "relative isolate @max-[48rem]:border-b @max-[48rem]:border-primary-700",
        ...
        >
            {columns.map((column, columnIndex) => {
                const isAction =
                    column.mobile === "actions" || column.mobile === "footer-actions";
                return (
                    <td
                        key={column.id}
                        className={cn(
                            ...
                            compact &&
                                ...
                                cn(
                                    ...
                                    !hasInlineActions && "@max-[48rem]:col-span-2"
                                ),
                            compact &&
                    ...
                    >
                        ...
                        <div
                            className={cn(
                                ...
                                rowAction && !isAction && "pointer-events-none"
                            )}
                        >
                            <span
                                className={cn(
